...
public class UserProfileController {
    ...
    @Operation(summary = "사용자 프로필 정보 조회", description = "로그인한 사용자가 userId로 사용자 프로필 정보(이름, 프로필 사진, 한 줄 소개)를 조회합니다.")
    ...
    @Operation(summary = "내 프로필 수정", description = "로그인한 사용자가 자신의 프로필 정보를 수정합니다. (이름, 한 줄 소개, 프로필 이미지) " +
